"""Shop-owner Flask entrypoint (seller website) sharing the common backend."""
...
from models.constants import ROLE_SHOP_OWNER
from routes import register_routes

# Shared Firebase project (same as admin and user sites).
firebaseConfig = {
...
app.config["ALLOWED_ROLES"] = {ROLE_SHOP_OWNER}

register_routes(app, include=("auth", "shop"))
